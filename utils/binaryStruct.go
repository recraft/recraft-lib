...
// Note: This function depends on reflect, any error can give a panic, it should be modified.
...
// StructToBinary converts any structs to binary data types from the Minecraft protocol.
// The order can be know by tags.
// Note: This function depends on reflect, any error can give a panic, it should be modified.
